              ...
              <div className=" p-2 ">
                ...
                <ul className="flex justify-center mt-4 space-x-4  ">
                  <li className="border-2 border-gray-500 rounded-md ">
                    <a href="/CheckshotDemo" className="text-gray-500 hover:text-green-700 flex flex-col items-center p-3 ">
                      <FaFileImage className="text-4xl  " />
                      <p className="text-sm">Image</p>
                    </a>
                  </li>
                  <li className="border-2 border-gray-500 rounded-md ">
                    <a href="/CheckshotVidDemo" className="text-gray-500 hover:text-green-700 flex flex-col items-center p-3">
