          ...
          <div className="flex">
            <ul className="flex gap-4">
              ...
              <Link to="DemoLandingPage" onClick={handleLinkClick}>
                <button className="font-semibold text-green-800 hover:bg-green-700 hover:text-white hover:rounded-md transition-all duration-300 ease-linear cursor-pointer text-bold px-4 py-3">DEMO</button>
              </Link>
              {/* end by umair */}
            </ul>
          </div>
