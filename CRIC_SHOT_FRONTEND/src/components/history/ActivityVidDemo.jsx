...
const ActivityVidDemo = () => {
  ...
  useEffect(() => {
    ...
    const dummyData = [
      {
        id: 1,
        date: new Date("2024-08-20T14:30:00Z"),
        numberOfShots: 5,
        betterShot: "Cover Drive",
        weakShot: "Pull Shot",
        predictedVideo: Vid1,
      },
      {
        ...
        numberOfShots: 12,
        betterShot: "Reverse Sweep",
        weakShot: "Bowled",
        predictedVideo: Vid1,
      },
      {
        id: 3,
        date: new Date("2024-08-15T09:15:00Z"),
        numberOfShots: 20,
        betterShot: "Cover Drive",
        weakShot: "Pull Shot",
        predictedVideo: Vid1,
              ...
              <div className="p-4 bg-gray-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex  items-center ">
                    <button onClick={() => handleDownloadVideo(Vid1)} className="bg-green-500 text-white px-2 py-1 rounded-lg mt-2 "><FaDownload /></button>
                  </div>
              </div>
            </div>
          ))
